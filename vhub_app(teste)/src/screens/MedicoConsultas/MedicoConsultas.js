...
const Consultas = [
    ...
    { id: 2, nome: "Gustavo Magalhães", situacao: "realizado" },
];
...
export const MedicoConsultas = ({ navigation }) => {
    ...
    return (
        <Container>
            <HeaderHome>
                <UserDoctor
                    source={{ uri: "https://avatars.githubusercontent.com/u/125309990?v=4" }}
                />
                <InfoContainer>
                    <UserText>Bem-vindo(a)</UserText>
                    <MontSerratWhite>Dra. Rebeca </MontSerratWhite>
                </InfoContainer>

                <FontAwesome name="heart" left={95} top={55} size={24} color="white" />
            </HeaderHome>
