...
export const ViewPrescription = () => {
    return (
        <ContainerUser contentContainerStyle={{ flexGrow: 1, alignItems: 'center' }}>
            <PhotoContainer>
                <UserContainer source={{ uri: "https://avatars.githubusercontent.com/u/125309990?v=4" }} />
            </PhotoContainer>

            <ContentProntuario>
                <TitleUser>Dra. Rebeca</TitleUser>
                <SubTextQuick>Cliníco geral   CRM-15286</SubTextQuick>
            </ContentProntuario>

            <LabelUser>Descrição da consulta</LabelUser>
            <InputUser style={{ height: 121, fontFamily: 'MontserratAlternates_500Medium', paddingBottom: 20 }}
            ...
            <View style={{ width: '90%', alignItems: 'center', flexDirection: 'row', borderBottomWidth: 2, paddingBottom: 10, borderColor: '#8C8A97' }}>
                ...
                <CancelText style={{ color: '#C81D25', left: 60 }}>Cancelar</CancelText>
            </View>
